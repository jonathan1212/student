...
/**
 * This class defines the structure of the 'tblStudent' table.
 *
 *
...
class StudentTableMap extends TableMap {
	...
	public function initialize()
	{
	  // attributes
		...
		$this->addColumn('STUDENT_ID', 'StudentId', 'INTEGER', false, null, null);
		...
		$this->addColumn('PROFILE_PICT', 'ProfilePict', 'VARCHAR', false, 255, null);
	...
	{
    $this->addRelation('StudentCourse', 'StudentCourse', RelationMap::ONE_TO_MANY, array('id' => 'student_id', ), null, null);
	} // buildRelations()
