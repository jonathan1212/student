...
/**
 * Base static class for performing query and update operations on the 'tblSubject' table.
 *
 * 
 *
...
abstract class BaseSubjectPeer {
	...
	const ID = 'tblSubject.ID';

	/** the column name for the SUBJECT_NAME field */
	const SUBJECT_NAME = 'tblSubject.SUBJECT_NAME';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('ID', 'SubjectName', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('iD', 'subjectName', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::SUBJECT_NAME, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'subject_name', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('ID' => 0, 'SubjectName' => 1, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('iD' => 0, 'subjectName' => 1, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::SUBJECT_NAME => 1, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'subject_name' => 1, ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(SubjectPeer::SUBJECT_NAME);
	}
	...
	/**
	 * Method to invalidate the instance pool of all tables related to tblSubject
	...
	/**
	 * Method to DELETE all rows from the tblSubject table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	{
	  return array(array('subject_name'));
	}
