...
/**
 * Base class that represents a row from the 'tblStudent' table.
 *
 * 
 *
...
abstract class BaseStudent extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the profile_pict field.
	 * @var        string
	 */
	protected $profile_pict;
	...
	/**
	 * Get the [profile_pict] column value.
	 * 
	 * @return     string
	 */
	...
	/**
	 * Set the value of [profile_pict] column.
	 * 
	 * @param      string $v new value
	 * @return     Student The current object (for fluent API support)
	 */
	public function setProfilePict($v)
	{
		if ($v !== null) {
			$v = (string) $v;
		}

		if ($this->profile_pict !== $v) {
			$this->profile_pict = $v;
			$this->modifiedColumns[] = StudentPeer::PROFILE_PICT;
		}
	...
	public function setdateAdded($v)
	{
		...
		if ( $this->date_added !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = StudentPeer::DATE_ADDED;
			}
		} // if either are not null
	...
	public function setIsActive($v)
	{
		...
		if ($this->is_active !== $v) {
			$this->is_active = $v;
			$this->modifiedColumns[] = StudentPeer::IS_ACTIVE;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->profile_pict = ($row[$startcol + 6] !== null) ? (string) $row[$startcol + 6] : null;
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[6], $arr)) $this->setProfilePict($arr[$keys[6]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(StudentPeer::PROFILE_PICT)) $criteria->add(StudentPeer::PROFILE_PICT, $this->profile_pict);
		if ($this->isColumnModified(StudentPeer::DATE_OF_BIRTH)) $criteria->add(StudentPeer::DATE_OF_BIRTH, $this->date_of_birth);
		if ($this->isColumnModified(StudentPeer::DATE_ADDED)) $criteria->add(StudentPeer::DATE_ADDED, $this->date_added);
		if ($this->isColumnModified(StudentPeer::IS_ACTIVE)) $criteria->add(StudentPeer::IS_ACTIVE, $this->is_active);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setProfilePict($this->profile_pict);
	 ...
	 * related StudentCourses from storage. If this Student is new, it will return
		...
		if ($this->collStudentCourses === null) {
			if ($this->isNew()) {
			   $this->collStudentCourses = array();
				...
				$criteria->add(StudentCoursePeer::STUDENT_ID, $this->id);
	 ...
	 * actually need in Student.
	 */
	public function getStudentCoursesJoinYearLevel($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(StudentPeer::DATABASE_NAME);
		}
		...
		if ($this->collStudentCourses === null) {
			if ($this->isNew()) {
				...
				$this->collStudentCourses = StudentCoursePeer::doSelectJoinYearLevel($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
