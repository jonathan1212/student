...
/**
 * Base static class for performing query and update operations on the 'tblCourse' table.
 *
 * 
 *
...
abstract class BaseCoursePeer {
	...
	const ID = 'tblCourse.ID';

	/** the column name for the COURSE_NAME field */
	const COURSE_NAME = 'tblCourse.COURSE_NAME';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('ID', 'CourseName', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('iD', 'courseName', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::COURSE_NAME, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'course_name', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('ID' => 0, 'CourseName' => 1, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('iD' => 0, 'courseName' => 1, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::COURSE_NAME => 1, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'course_name' => 1, ),
		BasePeer::TYPE_NUM => array (0, 1, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(CoursePeer::COURSE_NAME);
	}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
		...
		{
		  call_user_func($sf_hook, 'BaseCoursePeer', $criteria, $con);
		}
	...
	/**
	 * Method to invalidate the instance pool of all tables related to tblCourse
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCoursePeer:doInsert:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseCoursePeer', $values, $con))
      {
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCoursePeer:doInsert:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseCoursePeer', $values, $con, $pk);
    }
	...
	{
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCoursePeer:doUpdate:pre') as $sf_hook)
    {
      if (false !== $sf_hook_retval = call_user_func($sf_hook, 'BaseCoursePeer', $values, $con))
      {
        return $sf_hook_retval;
    ...
    // symfony_behaviors behavior
    foreach (sfMixer::getCallables('BaseCoursePeer:doUpdate:post') as $sf_hook)
    {
      call_user_func($sf_hook, 'BaseCoursePeer', $values, $con, $ret);
    }
	...
	/**
	 * Method to DELETE all rows from the tblCourse table.
	 *
	 * @return     int The number of affected rows (if supported by underlying database driver).
	 */
	...
	{
	  return array(array('course_name'));
	}
	...
	static private function getMixerPreSelectHook($method)
	{
	  ...
	  {
	    return sprintf('BaseCoursePeer:%s:%1$s', 'Count' == $match[1] ? 'doCount' : $match[0]);
	  }
